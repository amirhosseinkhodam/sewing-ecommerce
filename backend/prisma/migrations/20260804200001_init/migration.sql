...
-- CreateEnum
CREATE TYPE "ShippingMethod" AS ENUM ('POST', 'COURIER');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('ZARINPAL', 'CARD_TO_CARD');
...
CREATE TABLE "Order" (
    ...
    "paymentMethod" "PaymentMethod" NOT NULL DEFAULT 'CARD_TO_CARD',
